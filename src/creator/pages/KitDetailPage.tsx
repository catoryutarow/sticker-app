          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 sm:px-4 py-2 rounded-lg bg-white text-emerald-600 hover:bg-emerald-50 text-sm font-medium transition-colors flex items-center gap-1.5 shadow-sm"
              >
