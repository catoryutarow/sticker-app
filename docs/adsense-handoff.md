...
| 運営者情報 | `/about` | ○ | 株式会社スポルアップ記載、公式サイトへの外部リンクあり |
...
- [ ] **記事を最低 10〜15 本に増やす**（AdSense 通過の実績値。1本は明らかに不足）
  ...
  - テーマ案:
    ...
    5. 音楽アプリで子どもと遊ぶアイデア
    6. ワークショップ事例・活用例（運営のスポルアップ実績と連動）
...
- [ ] **E-E-A-T の発揮**: 記事の文章中に **株式会社スポルアップとしての専門性**（音楽コンサルティング・ワークショップ実績・QOML経営理念）を織り込む。具体的には:
...
- [ ] **`/about` をリッチ化**
  ...
  - 追加すべき内容: サービスの着想ストーリー、運営者の専門性（音楽コンサルタント/スポルアップの事業）、更新ポリシー、コンタクト、E-E-A-T 要素
